...
public class DiaryDAO {
	...
	public boolean write(String id, String subject, String content) {//db에 들어갔는지 확인하기... 디테일로 가야겠지? 일단 확인해보려면 근데 그냥 목록으로가도...되굿...
		...
		//리스트 보여주기
		public ArrayList<DiaryDTO> list(String homephost) {//반환하는 값이 arraylist인 list이고 list안에 넣은값이 dto라  반환타입이 ArrayList<DiaryDTO>이다.
			...
			String sql = "SELECT diaryidx,id,diarysubject,diarybhit,diaryreg_date FROM diary where id=? ORDER BY diaryidx DESC";//diaryidx기준으로 내림차순
